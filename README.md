...
* 示例步骤
    ...
    5. 使用 gcc 或 clang 编译输出的 .c 文件，例如：```clang 程序名.c -o 程序名 -flto -I /path/to/quickjs/include -L /path/to/quickjs/lib /path/to/libquickjs.lto.a -lm -ldl -lpthread```，即可生成更新js功能后的服务程序；
